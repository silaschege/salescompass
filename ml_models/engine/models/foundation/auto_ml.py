...
try:
    ...
    try:
        from engine.models.foundation.base_model import BaseModel, model_registry
        from infrastructure.config.ontology_config import ModelSpecification, ModelType as OntModelType
        from engine.models.foundation.model_factory import ModelFactory
    except ImportError:
        ...
        try:
            ...
            try:
                from infrastructure.config.ontology_config import ModelSpecification, ModelType as OntModelType
                from infrastructure.config.model_factory import ModelFactory
            except ImportError:
                from ....infrastructure.config.ontology_config import ModelSpecification, ModelType as OntModelType
