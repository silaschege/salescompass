...
urlpatterns = [
    ...
    # === Migrated Platform Invoice Management ===
    
    # Tenant History & Search
    ...
    # Dynamic Choices
    path('dynamic-choices/<str:model_name>/', views.get_invoicing_dynamic_choices, name='get_invoicing_dynamic_choices'),
]
