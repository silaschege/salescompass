...
from .models import CustomField, ModuleLabel, AssignmentRule, PipelineStage, EmailIntegration, BehavioralScoringRule, DemographicScoringRule, ModelChoice, FieldType, ModuleChoice, AssignmentRuleType, PipelineType, EmailProvider, ActionType, OperatorType
from tenants.models import Tenant as TenantModel, Setting, SettingType
from core.forms import DynamicChoiceWidget

class SettingForm(forms.ModelForm):
    class Meta:
        model = Setting
        fields = ['group', 'setting_name', 'setting_label', 'setting_description', 'setting_type', 'setting_type_ref',
...
class CustomFieldForm(forms.ModelForm):
    class Meta:
        model = CustomField
        fields = ['model_name', 'model_name_ref', 'field_name', 'field_label', 'field_type', 'field_type_ref', 'field_options', 
...
class AssignmentRuleForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['assignment_rule_name', 'module', 'module_ref', 'rule_type', 'rule_type_ref', 'criteria', 'assigned_to', 'rule_is_active', 'priority']
...
class PipelineStageForm(forms.ModelForm):
    class Meta:
        model = PipelineStage
        fields = ['pipeline_type', 'pipeline_type_ref', 'pipeline_stage_name', 'stage_description', 'order', 'probability', 
...
class BehavioralScoringRuleForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['behavioral_scoring_rule_name', 'action_type', 'action_type_ref', 'points', 'time_decay_factor', 
