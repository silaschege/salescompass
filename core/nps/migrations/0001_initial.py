    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger_event', models.CharField(choices=[('account.onboarded', 'Account Onboarded'), ('case.closed', 'Case Closed'), ('renewal.completed', 'Renewal Completed'), ('manual', 'Manual')], default='manual', max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nps_responses', to='accounts.account')),
