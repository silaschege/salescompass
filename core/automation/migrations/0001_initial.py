...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('workflow_action_type', models.CharField(choices=[('send_email', 'Send Email'), ('create_task', 'Create Task'), ('update_field', 'Update Field'), ('run_function', 'Run Function'), ('create_case', 'Create Case'), ('assign_owner', 'Assign Owner'), ('send_slack_message', 'Send Slack Message'), ('webhook', 'Webhook'), ('create_nba', 'Create Next Best Action'), ('send_sms', 'Send SMS'), ('send_teams_message', 'Send Microsoft Teams Message'), ('send_whatsapp', 'Send WhatsApp Message'), ('convert_lead_to_account', 'Convert Lead to Account'), ('approval', 'Request Approval'), ('delay', 'Delay Execution'), ('loop', 'Loop/Iterate'), ('custom_code', 'Custom Code Action')], help_text='Type of action to perform', max_length=50)),
