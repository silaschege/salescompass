from core.views import (
    SalesCompassListView, SalesCompassCreateView, SalesCompassUpdateView, SalesCompassDeleteView
)
from django.urls import reverse_lazy
from django.contrib import messages
from .models import AutomationRule

class AutomationRuleListView(SalesCompassListView):
...
class AutomationRuleCreateView(SalesCompassCreateView):
    model = AutomationRule
...
class AutomationRuleUpdateView(SalesCompassUpdateView):
    model = AutomationRule
    template_name = 'automation/rule_form.html'
    fields = ['automation_rule_name', 'automation_rule_description', 'trigger_type', 'conditions', 'actions', 'automation_rule_is_active']
    success_url = reverse_lazy('automation:rule_list')
...
class AutomationRuleDeleteView(SalesCompassDeleteView):
    model = AutomationRule
