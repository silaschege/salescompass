    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(help_text='Name of the webhook', max_length=255)),
                ('url', models.URLField(help_text='The URL to send webhook payloads to')),
                ('events', models.JSONField(blank=True, default=list, help_text='Types of events that trigger this webhook')),
