...
urlpatterns = [
    ...
    path('zones/create/', views.WarehouseZoneCreateView.as_view(), name='zone_create'),
    path('zones/<int:pk>/edit/', views.WarehouseZoneUpdateView.as_view(), name='zone_update'),
    ...
    # Reports
    path('valuation/', views.StockValuationReportView.as_view(), name='valuation_report'),
    path('valuation/export/', views.StockValuationExportView.as_view(), name='valuation_export'),
    
    # API
    path('api/lookup-barcode/', views.ProductBarcodeLookupView.as_view(), name='api_lookup_barcode'),
]
