...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='tenant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lead_action_types', to='tenants.tenant'),
        ),
        migrations.AddField(
            model_name='assignmentrule',
            name='assigned_to',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lead_assigned_rules', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='assignmentrule',
            name='rule_type_ref',
