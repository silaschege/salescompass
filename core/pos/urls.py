...
urlpatterns = [
    ...
    path('api/transactions/sync-offline/', views.OfflineTransactionSyncAPI.as_view(), name='api_sync_offline'),
    path('api/dashboard/stats/', views.DashboardStatsAPI.as_view(), name='api_dashboard_stats'),
    ...
    path('api/hardware/scan-printers/', views.PrinterDiscoveryAPI.as_view(), name='api_scan_printers'),
