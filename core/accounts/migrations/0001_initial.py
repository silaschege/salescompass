    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(blank=True, choices=[('tech', 'Technology'), ('manufacturing', 'Manufacturing'), ('finance', 'Finance'), ('healthcare', 'Healthcare'), ('retail', 'Retail'), ('energy', 'Energy'), ('education', 'Education'), ('other', 'Other')], max_length=100)),
                ...
                ('esg_engagement', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High')], default='low', max_length=20)),
                ('gdpr_consent', models.BooleanField(default=False)),
                ('ccpa_consent', models.BooleanField(default=False)),
                ('partners', models.JSONField(blank=True, default=list, help_text='List of partners involved with this account')),
                ('competitors', models.JSONField(blank=True, default=list, help_text='List of competitors for this account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('account_manager', 'Account Manager'), ('sales_engineer', 'Sales Engineer'), ('executive_sponsor', 'Executive Sponsor'), ('customer_success', 'Customer Success Manager'), ('support_lead', 'Support Lead'), ('other', 'Member')], default='other', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, help_text='Role or job title of the contact', max_length=100)),
                ('communication_preference', models.CharField(choices=[('email', 'Email'), ('phone', 'Phone'), ('mail', 'Mail'), ('text', 'Text/SMS')], default='email', help_text='Preferred method of communication', max_length=20)),
                ('is_primary', models.BooleanField(default=False, help_text='Is this the primary contact for the account?')),
                ('esg_influence', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High')], default='low', help_text='Level of influence on ESG decisions', max_length=20)),
            ],
            options={
                'abstract': False,
            },
