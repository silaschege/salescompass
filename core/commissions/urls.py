...
urlpatterns = [
    ...
    path('payments/<int:pk>/pdf/', views.StatementExportView.as_view(), name='payment_statement_pdf'),
    ...
    path('api/calculate-preview/', views.WhatIfCalculationAPIView.as_view(), name='calculate_preview'),
