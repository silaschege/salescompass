...
# Supplier model moved to `suppliers` app - see suppliers.models.Supplier
...
class Product(TenantModel):
    ...
    has_serial_numbers = models.BooleanField(default=False, help_text="Track individual items with unique serial numbers")
