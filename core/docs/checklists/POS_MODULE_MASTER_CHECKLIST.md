...
- [x] **Barcode Scanners**
  - [x] USB/Bluetooth scanner support
...
### Phase 1 (Sprint 1-2)
1. Split payment support [x]
2. Held transactions [x]
3. Barcode scanner integration [x]

### Phase 2 (Sprint 3-4)
1. Offline mode foundation [x]
2. Real-time dashboard [x]
3. Receipt printer auto-discovery [x]
